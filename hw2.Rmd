...
After creating the dataframe, we can use dplyr to manipulate the dataframe. Jacob and Brown are the most common first and last names, respectively, in the dataset. 
```{r}
lego_df %>%
