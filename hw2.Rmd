...
name0 = sales %>% 
    ...
    names() %>% 
    unique()
>>>>>>> 77297938f79ffbec09f63ed178bf5b4f27e9f326
...
>>>>>>> 861ad377d27b5a182ab440e930bf5ae1dec36afc
...
Looping over each individual's hobbies in sales data we can get a table of everyone's hbbies. After manually sorting we found that slicing the top 12 rows will give us the result. Note that all hobbies tied No.4 are considered among the five most popular hobbies. 
```{r}
