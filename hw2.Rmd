...
```{r}
a = sapply(sales, function(x) x$hobbies) %>% unlist()
...
```{r}
area_code = list(Alaska = c(907), Alabama = c(205,251,256,334), 
     Arkansas = c(479,501,870), Arizona = c(480, 520, 602, 623,928))

phone_code = lego_df %>%
    select(first_name, last_name, phone_number) %>%
    distinct() %>%
    transmute(strsplit(phone_number, '-'))
```
